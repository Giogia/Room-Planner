...
class MockXRFrame {
    ...
    getInputPose(_xrInputSource, _frameOfRef) {
        return {};
    }
    ...
    const stubWebXrInterface = (arRenderer) => {
        ...
        arRenderer.resolveARSession = async () => {
            class FakeSession extends EventTarget {
                ...
                async requestReferenceSpace(_options) {
                    return {
                        originOffset: {
                            position: {},
                            orientation: {},
                 ...
                 */
                async requestHitTest(origin, dir, _frameOfRef) {
                    const hits = [];
    ...
    suite('when presenting a scene', () => {
        ...
        suite('placing a model', () => {
            ...
            test('ignores when ray fails', async () => {
                ...
                arRenderer.camera.matrix.identity().makeRotationAxis(new Vector3(1, 0, 0), Math.PI / 2);
